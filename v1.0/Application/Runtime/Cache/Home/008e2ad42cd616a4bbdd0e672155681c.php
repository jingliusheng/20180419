...
<link rel="stylesheet" href="/Public/Home/css/mod/model.css">
	...
	<link rel="stylesheet" href="/Public/Home/css/user/index.css">
...
<div id="main">
  <div class="main-wrapper">
	...
	<div class="main-content">
		...
		<div class="lh-user">
			<img src="/Public/Home/img/web/logo-icon.png" width="80" height="80" class="lh-userInfo-avatar lh-user-avatar">
			<div class="lh-user-msg">
				<p>
					<span class="lh-user-name">12041000833</span>
					<span class="lh-bindPhone">绑定手机</span>
				</p>
				<p>
				  <span class="lh-user-level"><span></span>等级：Lv110</span>
					<span class="lh-user-nextLevel">（距离Lv2只差350）</span>
				</p>
			</div>
		</div>
		<div class="lh-lucky-records">
			<h3>幸运记录</h3>
			<table class="lh-lucky-records-table">
				<thead>
					<tr>
						<th width="98">编号</th>
						<th width="257">幸运时间</th>
						<th width="166">幸运类型</th>
						<th width="211">幸运币</th>
						<th width="122">金额</th>
						<th width="244"></th>
					</tr>
